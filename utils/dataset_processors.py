            ...
            df.append(
                {
                    ...
                    "text": text,
                    "token_len": 0,
                    "EXT": 1 if line[7].lower().replace('"','').replace("'",'').strip() == "y" else 0,
                    "NEU": 1 if line[8].lower().replace('"','').replace("'",'').strip() == "y" else 0,
                    "AGR": 1 if line[9].lower().replace('"','').replace("'",'').strip() == "y" else 0,
                    "CON": 1 if line[10].lower().replace('"','').replace("'",'').strip() == "y" else 0,
                    "OPN": 1 if line[11].lower().replace('"','').replace("'",'').strip() == "y" else 0,
                }
            )
